...
for_clasico_stmt:
    RW_FOR stmt_asignar? PUNTO_Y_COMA expr? PUNTO_Y_COMA stmt_asignar? LLAVE_IZQ stmt* LLAVE_DER # ForClasicoStmt;

for_stmt:
    RW_FOR ID (COMA ID)? RW_IN (expr | range) LLAVE_IZQ stmt* LLAVE_DER # ForStmt;
